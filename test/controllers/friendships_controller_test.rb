...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { accepted: @friendship.accepted, granter_id: @friendship.granter_id, requester_id: @friendship.requester_id }
    end
  ...
  test "should update friendship" do
    patch :update, id: @friendship, friendship: { accepted: @friendship.accepted, granter_id: @friendship.granter_id, requester_id: @friendship.requester_id }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
